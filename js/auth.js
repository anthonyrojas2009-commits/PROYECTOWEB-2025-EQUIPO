document.addEventListener('DOMContentLoaded', () => {
    ...
    const obtenerUsuarios = () => {
        ...
        if (usuarios.length === 0) {
            const adminDefault = {
                ...
                password: 'password123', // ¡RECORDATORIO: Usar Hash en producción!
                rol: 'Administrador',
                estado: 'Activo'
            };
    ...
    // --- 2. LÓGICA DE REGISTRO (Para registro.html, ubicado en /page) ---
    ...
    if (formRegistro) {
        formRegistro.addEventListener('submit', (e) => {
            ...
            // Usamos los IDs del formulario de REGISTRO que definimos en registro.html
            ...
            // REDIRECCIÓN CORREGIDA: Desde /page/registro.html, salimos a ../index.html
            window.location.href = '../index.html'; 
        });
    }

    // --- 3. LÓGICA DE INICIO DE SESIÓN (Para index.html, ubicado en la Raíz) ---
    ...
    if (formLogin) {
        formLogin.addEventListener('submit', (e) => {
            ...
            // Usamos los IDs del formulario de LOGIN que definimos en index.html
            ...
            // Inicio de sesión exitoso: guardar datos básicos en sessionStorage
            ...
            // REDIRECCIÓN CORREGIDA: Desde index.html, entramos a page/escritorio.html
    ...
    // Esta función debe ser global para poder ser llamada desde escritorio.js
    window.cerrarSesion = function() {
        sessionStorage.removeItem('usuarioLogueado');
        alert("Sesión cerrada. Redirigiendo a la página de inicio.");
        // REDIRECCIÓN CORREGIDA: Desde /page/escritorio.html, salimos a ../index.html
        window.location.href = '../index.html'; 
    };
});